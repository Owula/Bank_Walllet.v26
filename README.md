...
<body class="bg-black text-white overflow-hidden">
    ...
    <!-- CHAT US SCREEN -->
    <div id="chatUsScreen" class="screen hidden fixed inset-0 bg-white flex flex-col z-[100]">
        <div class="bg-white border-b p-4 flex items-center">
            <button onclick="closeChatUs()" class="text-3xl mr-4 text-black">←</button>
            <h1 class="text-2xl font-bold text-black">Chat Us</h1>
        </div>
        
        <div class="flex-1 p-6 space-y-6">
            <div onclick="openTelegramChat()" 
                 class="bg-white border border-gray-200 rounded-3xl p-5 flex items-center justify-between cursor-pointer active:scale-[0.98]">
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 bg-[#229ED9] rounded-2xl flex items-center justify-center text-white text-2xl">📱</div>
                    <div>
                        <p class="font-semibold text-black">Chat us on Telegram</p>
                    </div>
                </div>
                <div class="bg-[#22c55e] text-white px-6 py-2 rounded-2xl font-bold">Open</div>
            </div>
            
            <div onclick="joinTelegramGroup()" 
                 class="bg-white border border-gray-200 rounded-3xl p-5 flex items-center justify-between cursor-pointer active:scale-[0.98]">
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 bg-[#229ED9] rounded-2xl flex items-center justify-center text-white text-2xl">👥</div>
                    <div>
                        <p class="font-semibold text-black">Join our telegram group</p>
                        <p class="text-sm text-gray-500">Tap to join the group</p>
                    </div>
                </div>
                <div class="bg-[#22c55e] text-white px-6 py-2 rounded-2xl font-bold">Join</div>
            </div>
        </div>
    </div>
    ...
    <div id="minerPlansScreen" class="screen hidden fixed inset-0 bg-[#0a1f14] flex flex-col z-50 overflow-auto p-5">
        ...
        <div class="bg-[#22c55e] rounded-3xl p-6 mb-5 text-black">
            ...
            <p class="text-sm leading-tight">
                This Miner Plan Can Only Mine <span class="font-bold text-base">₦76,000</span> Once A Day And you Can only Withdraw Once day With With a One Time Activation For Security Purposes
            </p>
        </div>
        ...
        <div class="bg-[#22c55e] rounded-3xl p-6 mb-5 text-black">
            <div class="flex justify-between items-center mb-3">
                ...
                <div class="text-right">
                    <div class="text-xs">Price Of Miner :</div>
                    <div class="font-bold">₦5,000</div>
                </div>
            </div>
            <p class="text-sm leading-tight mb-4">This Miner Can Mine ₦150,000 3 Times A Day...</p>
        ...
        <div class="bg-[#22c55e] rounded-3xl p-6 mb-5 text-black">
            ...
            <p class="text-sm leading-tight mb-4">This Miner Can Mine ₦500,000 7 Times A Day...</p>
        ...
        <div class="bg-[#22c55e] rounded-3xl p-6 text-black">
            ...
            <p class="text-sm leading-tight mb-4">This Miner Can Mine ₦80,000 Every 5 Minutes...</p>
    ...
    <div id="buyCodeScreen" class="screen hidden fixed inset-0 bg-[#0a1f14] flex flex-col z-50 overflow-auto">
        <div class="p-6">
            ...
            <div class="bg-[#22c55e] text-black rounded-3xl p-6 mb-6">
                ...
                <p class="text-sm mt-3">After input your account number and click confirm to you will receive your activation code between 3mins after verification</p>
            </div>
    ...
    <script>
        ...
        window.startMining = function() {
            if (hasMined) {
                alert("You have already mined your daily ₦76,000");
                return;
            }
        ...
        window.confirmStartMining = function() {
            ...
            transactions.unshift({ type: "Mining", amount: 76000, time: new Date().toLocaleTimeString([], {hour:'2-digit', minute:'2-digit'}) });
            hasMined = true;
